...
class RealisationController extends AbstractController
{
    ...
    /**
     * @Route("/list", name="realisation_list", methods={"GET"})
     * @return Response
     */
    public function list(RealisationRepository $realisationRepository): Response
    {
        //$realisationRepository = new  RealisationRepository();
        return $this->render('default/list_realisation.html.twig', [
            'realisations' => $realisationRepository->findAll(),
        ]);
    }
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $realisation->setIdPersonne($user);
            //end a modifier
